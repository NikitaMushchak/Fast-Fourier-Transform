...
for(size_t i = middle; i < newInfluenceMatrix.size(); ++i){
   InfluenceVector1.push_back(newInfluenceMatrix[i][middle]);
}
...
fft2(InfluenceVector1 , InfluenceVector2);
std::cout<<"Inf vector size = "<<InfluenceVector1.size()<<std::endl;
