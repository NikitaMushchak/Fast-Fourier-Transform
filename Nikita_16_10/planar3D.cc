...
int planar3D(
    ...
    buildInfluenceVector(InfluenceVector,
                        axMax,
                         zP,
                        openingAtTheStart,
                        barriers);
...
std::cout<<"Inf matrix size = "<<influenceMatrix.size()<<std::endl;
...
std::cout<<"\n new Inf matix size = "<<newInfluenceMatrix.size()<<std::endl;
 ai::saveMatrix("./Inf",newInfluenceMatrix );
...
//     tempInfluenceVector.clear();
 ...
 // std::cout<<"while"<<std::endl;
        calculatePressure(pressure,InfluenceVector, index, activeElements,
             WkNew, dSigmaCol, Wk.size());
            // calculatePressureDir(pressure, index, activeElements,
            //     partialInfluenceMatrix, WkNew, dSigmaCol, Wk.size());
// std::cout<<"calc Press"<<std::endl;
